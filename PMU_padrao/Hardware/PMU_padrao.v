...
always @ (posedge clk) begin
   ...
   if (mem_addr_wr == 585 && mem_wr) me2_f_main_v_x_e_ <= sm_me2*$pow(2.0,e_me2);
   if (mem_addr_wr == 587 && mem_wr) me1_f_main_v_ph_e_ <= out;
   if (mem_addr_wr == 588 && mem_wr) me2_f_main_v_yr_e_ <= sm_me2*$pow(2.0,e_me2);
   if (mem_addr_wr == 589 && mem_wr) me2_f_main_v_yi_e_ <= sm_me2*$pow(2.0,e_me2);
   if (mem_addr_wr == 590 && mem_wr) me2_f_main_v_accr_e_ <= sm_me2*$pow(2.0,e_me2);
   if (mem_addr_wr == 591 && mem_wr) me2_f_main_v_acci_e_ <= sm_me2*$pow(2.0,e_me2);
   if (mem_addr_wr == 592 && mem_wr) me1_f_main_v_idx_e_ <= out;
   if (mem_addr_wr == 593 && mem_wr) me1_f_main_v_k_e_ <= out;
   if (mem_addr_wr == 595 && mem_wr) me2_f_main_v_yi_out_e_ <= sm_me2*$pow(2.0,e_me2);
   if (mem_addr_wr == 596 && mem_wr) me3_f_main_v_y_i_e_ <= out;
   if (mem_addr_wr == 597 && mem_wr) me3_f_main_v_y_e_ <= out;
   if (mem_addr_wr == 598 && mem_wr) me2_f_main_v_dphi_e_ <= sm_me2*$pow(2.0,e_me2);
   if (mem_addr_wr == 601 && mem_wr) me3_f_main_v_rot_i_e_ <= out;
   if (mem_addr_wr == 602 && mem_wr) me3_f_main_v_rot_e_ <= out;
   if (mem_addr_wr == 609 && mem_wr) me2_f_main_v_fe_e_ <= sm_me2*$pow(2.0,e_me2);
   if (mem_addr_wr == 610 && mem_wr) me2_f_main_v_rocof_e_ <= sm_me2*$pow(2.0,e_me2);
end
...
always @ (posedge clk) begin
if (pc_sim_val < 273) linetab <= min[pc_sim_val];
linetabs <= linetab;   
